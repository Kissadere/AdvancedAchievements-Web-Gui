...
<link href="../css/throwneggs.css" rel="stylesheet">
</head>
<body>
   <div id="container">
   </div>
            ...
            <div class="col-1">
               <div id="wb_gridTopMisc">
                  <section id="gridTopMisc">
                     <div class="row">
                        <div class="col-1">
                           <div id="wb_mainTitle">
                              <span id="wb_uid0">HUEVOS LANZADOS</span>
                           </div>
                        </div>
                     </div>
                  </section>
               ...
               <div id="wb_gridFormContainer">
                  <form name="gridFormContainer" method="post" action="../builder/constructor.php" enctype="multipart/form-data" accept-charset="UTF-8" id="gridFormContainer">
                     <input type="hidden" name="achievementType" value="thrownEggs" id="achievementType">
