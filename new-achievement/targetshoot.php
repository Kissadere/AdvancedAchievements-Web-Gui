...
<link href="../css/targetshoot.css" rel="stylesheet">
</head>
<body>
   <div id="container">
   </div>
            ...
            <div class="col-1">
               <div id="wb_gridTopMisc">
                  <section id="gridTopMisc">
                     <div class="row">
                        <div class="col-1">
                           <div id="wb_mainTitle">
                              <span id="wb_uid0">DISPARAR OBJETIVOS</span>
                           </div>
                        </div>
                     </div>
                  </section>
               ...
               <div id="wb_gridFormContainer">
                  <form name="gridFormContainer" method="post" action="../builder/constructor.php" enctype="multipart/form-data" accept-charset="UTF-8" id="gridFormContainer">
                     <input type="hidden" name="achievementType" value="targetShoot" id="achievementType">
                     ...
                     <div class="row">
                        <div class="col-1">
                           ...
                           <div id="wb_formLabelMeta">
                              <span id="wb_uid4">NOMBRE DEL MATERIAL O ENTIDAD</span>
                           </div>
                           <div id="wb_formDescMeta">
                              <span id="wb_uid5">https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/Material.html <br>https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/entity/EntityType.html</span>
                           </div>
